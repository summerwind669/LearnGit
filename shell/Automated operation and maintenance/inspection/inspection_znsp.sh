...
function check_performance {
    ...
    ansible -i /home/ucp/hosts/hosts_all dm,crs,flume -m shell -a "top -bn1 | grep 'Cpu(s)\|Mem'; df -h /home /data" | while read -r line; do
